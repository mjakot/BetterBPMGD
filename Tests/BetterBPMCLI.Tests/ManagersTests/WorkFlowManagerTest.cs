...
namespace BetterBPMCLI.Tests.ManagersTests
{
    public class WorkFlowManagerTest
    {
        ...
        {
            PathSettingsMock settingsMock = new();
            ...
            WorkFlowManager manager = new(new(settingsMock));

            manager.NewTimingProject("testProject", -100, 0);
            manager.CurrentTimingProject.AddTiming(new(0, 2, false, 0, Common.SpeedPortalTypes.HALFSPEED, "ogo"));
            ...
            Assert.Equal(expectedLocalLevels, File.ReadAllText(settingsMock.GeometryDashLevelsSavePath));
        }
    }
}
